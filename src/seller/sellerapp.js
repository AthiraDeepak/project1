        ...
        <HashRouter>
            <nav className="navbar navbar-expand-sm navbar-dark bg-dark">
                <div className="container">
                    ...
                    <a  className="navbar-brand"> <li className="fa fa-shopping-bag fa-lg" ></li> Seller CRM </a>
                    ...
                    <ul className="navbar-nav ms-auto">
                        ...
                        <li className="nav-item me-4">
                            <Link className="nav-link text-warning">Hi,Seller One <i className="fa fa-power-off  me-2"></i> Logout </Link>
                        </li>
                    </ul>
                    </div>
                </div>
